			...
			<div className="board-update-container">
				<div className="board-update-box">
					...
					<div className="board-update-content-box">
						<textarea ref={contentRef} value={content} className="board-update-content-textarea" placeholder='본문을 작성해주세요.' onChange={onContentChangeHandler} />
					...
					<div className="board-update-images-box">
						{imageUrls.map((imageUrl, index) => (
							<div key={index} className="board-update-image-box">
								<img src={imageUrl} alt="" className="board-update-image" />
